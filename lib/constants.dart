...
const kPrimary = Color(0xFF884DFF);

final kText = GoogleFonts.barlow();

final kTermsandConditions =
    '''As a Host, iTravel offers you the opportunity to share your Accommodation, Experience, or other Host Service with our vibrant community of Guests - and earn money doing it. It’s easy to create a Listing and you are in control of how you host - set your price, availability, and rules for each Listing\nWhen you accept a booking request, or receive a booking confirmation through the iTravel Platform, you are entering into a contract directly with the Guest, and are responsible for delivering your Host Service under the terms and at the price specified in your Listing. You are also agreeing to pay applicable fees like iTravel’s service fee (and applicable taxes) for each booking. iTravel Payments will deduct amounts you owe from your payout unless we and you agree to a different method. Any terms, policies or conditions that you include in any supplemental contract with Guests must: (i) be consistent with these Terms, our Policies, and the information provided in your Listing, and (ii) be prominently disclosed in your Listing description\nYour relationship with iTravel is that of an independent individual or entity and not an employee, agent, joint venturer, or partner of iTravel, except that iTravel Payments acts as a payment collection agent as described in the Payments Terms. iTravel does not direct or control your Host Service, and you agree that you have complete discretion whether and when to provide Host Services, and at what price and on what terms to offer them.\nAfter each Host Service, Guests and Hosts will have an opportunity to review each other. Your Review must be accurate and may not contain any discriminatory, offensive, defamatory, or other language that violates our Content Policy or Review Policy. Reviews are not verified by iTravel for accuracy and may be incorrect or misleading. \nParts of the iTravel Platform enable you to provide feedback, text, photos, audio, video, information, and other content (collectively, “Content”). By providing Content, in whatever form and through whatever means, you grant iTravel a non-exclusive, worldwide, royalty-free, irrevocable, perpetual, sub-licensable and transferable license to copy, modify, prepare derivative works of, distribute, publish and otherwise exploit, that Content, without limitation. If Content includes personal information, our Privacy Policy describes how we use that personal information. Where iTravel pays for the creation of Content or facilitates its creation, iTravel may own that Content, in which case supplemental terms or disclosures will say that. You are solely responsible for all Content that you provide and warrant that you either own it or are authorized to grant iTravel the rights described in these Terms. You are responsible and liable if any of your Content violates or infringes the intellectual property or privacy rights of any third party. Content must comply with our Content Policy and Nondiscrimination Policy, which prohibit, among other things, discriminatory, obscene, harassing, deceptive, violent, and illegal content. You agree that iTravel may make available services or automated tools to translate Content and that your Content may be translated using such services or tools. iTravel does not guarantee the accuracy or quality of translations and Members are responsible for confirming the accuracy of such translations''';

final kPrivacyTerms = '''2. PERSONAL INFORMATION WE COLLECT

2.1 Information needed to use the iTravel Platform.

We collect personal information about you when you use the iTravel Platform. Without it, we may not be able to provide you with all services requested. This information includes:
...
You can choose to provide us with additional personal information. This information may include:
    ...
    Other Information. Such as when you fill in a form, add information to your account, respond to surveys, post to community forums, participate in promotions, communicate with our customer care team and other Members, or share your experience with us. This may include health information if you choose to share it with u

    3. HOW WE USE INFORMATION WE COLLECT
    3.1 Provide, Improve, and Develop the iTravel Platform. We use personal information to:

    enable you to access the iTravel Platform and make and receive payments,
    ...
    personalize and customize your experience based on your interactions with the iTravel Platform, your search and booking history, your profile information and preferences, and other content you submit, and
...
3.2 Create and Maintain a Trusted and Safer Environment. We use personal information to:
    ...
    in connection with the activities above, we may conduct profiling based on your interactions with the iTravel Platform, your profile information and other content you submit to iTravel, and information obtained from third parties. In limited cases, automated processes could restrict or suspend access to the iTravel Platform if such processes detect activity that we think poses a safety or other risk to iTravel, our community, or third parties. If you would like to challenge the decisioning based on the automated process, please contact us via the Contact Information section below.
...
3.3 Provide, Personalize, Measure, and Improve our Advertising and Marketing. We may use personal information to:
    ...
    administer referral programs, rewards, surveys, sweepstakes, contests, or other promotional activities or events sponsored or managed by iTravel or its third-party partners,
